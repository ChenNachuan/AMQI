...
\end{frame}
\subsection{CNE-5模型和行业收益归因}
\begin{frame}{CNE-5 模型与行业收益归因}
    \begin{itemize}
...
\begin{frame}{CNE-5 风格归因: 可视化与结论}
    \begin{figure}
        \centering
        % 请确保上传的文件名是 Barra_results.pdf，且路径正确
        % 调整高度以适应页面，保持长宽比
        \includegraphics[height=0.90\textheight]{pic/Barra_results.pdf}
        %\caption{RF vs XGB Cross-Sectional T-Statistics}
    \end{figure}
\end{frame}
